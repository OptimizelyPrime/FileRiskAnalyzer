...
def calculate_file_churn_score(commit_history: List[Dict[str, str]]) -> int:
    """
...
def calculate_repo_churn_scores(file_histories: Dict[str, List[Dict[str, str]]]) -> Dict[str, int]:
    """
    ...
    for file_path, history in file_histories.items():
        ...
        churn_scores[file_name] = calculate_file_churn_score(history)
    return churn_scores
